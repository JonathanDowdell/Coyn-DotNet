...
public class UserService: IUserService
{
    ...
    public async Task<UserEntity> SignUpUserAsync(SignUpUserRequest signUpUserRequest)
    {
        ...
        {
            Id = Guid.NewGuid(), Email = signUpUserRequest.Email,
        ...
        catch (DbUpdateException e)
        {
            ...
            {
                throw new CoynException(HttpStatusCode.Conflict, "Email already in use.");
            }
            throw new CoynException(HttpStatusCode.InternalServerError, e.Message);
        }
    ...
    public async Task<UserEntity> SignInUserAsync(SignInUserRequest signInUserRequest)
    {
        var user = await _apiDbContext.Users
            ...
            .FirstOrDefaultAsync(user => user.Email.ToLower() == signInUserRequest.Email.ToLower());

        if (user == null)
        {
            throw new CoynException(HttpStatusCode.Unauthorized, "Unauthorized Request");
        }
